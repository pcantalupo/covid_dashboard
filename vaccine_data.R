...
# DataTable ###############
# mimicking Google 'Vaccinations by Location' (on Country level)
...
two %>%
  ...
  facet_wrap(~vaxType) +
  theme(axis.text.x = element_text(angle = 90))  # google: 'ggplot rotate xaxis labels'
